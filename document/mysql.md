...
![](../static/Pasted%20image%2020230323170925.png)
...
![](../static/Pasted%20image%2020230324105416.png)

### redo log

`redo log`（重做日志）是`InnoDB`存储引擎独有的，它让`MySQL`拥有了崩溃恢复能力

![](../static/Pasted%20image%2020230324105452.png)
...
![](../static/Pasted%20image%2020230324110009.png)

`InnoDB` 存储引擎为 `redo log` 的刷盘策略提供了 `innodb_flush_log_at_trx_commit` 参数，它支持三种策略：

-   **0** ：设置为 0 的时候，表示每次事务提交时不进行刷盘操作
  ![](../static/Pasted%20image%2020230324110209.png)
-   **1** ：设置为 1 的时候，表示每次事务提交时都将进行刷盘操作（默认值）
  ![](../static/Pasted%20image%2020230324110219.png)
-   **2** ：设置为 2 的时候，表示每次事务提交时都只把 redo log buffer 内容写入 page cache
  ![](../static/Pasted%20image%2020230324110229.png)
...
![](../static/Pasted%20image%2020230324110840.png)
...
![](../static/Pasted%20image%2020230324111341.png)
...
![](../static/Pasted%20image%2020230324111453.png)
...
![](../static/Pasted%20image%2020230324111732.png)
