...
![](../static/Pasted%20image%2020230323142000.png)

### List

List 列表是简单的字符串列表，按照插入顺序排序，可以从头部或尾部向 List 列表添加元素

![](../static/Pasted%20image%2020230323142006.png)

### Hash

Hash 是一个键值对（key - value）集合

![](../static/Pasted%20image%2020230323142150.png)

### Set

Set 类型是一个无序并唯一的键值集合，它的存储顺序不会按照插入的先后顺序进行存储

![](../static/Pasted%20image%2020230323142219.png)

### Zset

Zset 类型（有序集合类型）相比于 Set 类型多了一个排序属性 score（分值），对于有序集合 ZSet 来说，每个存储元素相当于有两个值组成的，一个是有序集合的元素值，一个是排序值

![](../static/Pasted%20image%2020230323142305.png)
...
![](../static/Pasted%20image%2020230323143526.png)

- Always 每次写命令执行完成后同步写入硬盘
- Everysec 每秒将缓存写入硬盘
- No 由操作系统控制

![](../static/Pasted%20image%2020230323143336.png)
...
![](../static/Pasted%20image%2020230323145801.png)
...
![](../static/Pasted%20image%2020230323151055.png)
...
![](../static/Pasted%20image%2020230323151740.png)
...
![](../static/Pasted%20image%2020230323152726.png)
...
![](../static/Pasted%20image%2020230323154441.png)
